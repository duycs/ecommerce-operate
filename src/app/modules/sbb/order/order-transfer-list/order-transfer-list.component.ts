...
import { OrderTransferDataSource } from './order-transfer-data-source';
...
import { ConfirmOrderCompletedComponent } from '../confirm-order-completed/confirm-order-completed.component';
import { TransporterService } from 'src/app/services/transporter.service';

@Component({
    selector: 'app-order-transfer-list',
    templateUrl: './order-transfer-list.component.html',
})

export class OrderTransferListComponent implements OnInit {
    ...
    title: string = "Order";
    displayedColumns: string[] = ['selection', 'numericalOrder', 'code', 'transporter', 'supplier', 'orderNumber', 'quantity',
        'discount', 'totalPrice', 'totalImportedPrice', 'processStatus', 'quantityStatus', 'note', 'createdDate', 'action'];

    dataSource!: OrderTransferDataSource;
    ...
    constructor(
        ...
        this.dataSource = new OrderTransferDataSource(this.mappingModels, this.orderService);
    }
