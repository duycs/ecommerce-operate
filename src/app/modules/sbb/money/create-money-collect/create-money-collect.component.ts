...
@Component({
  ...
  templateUrl: './create-money-collect.component.html',
})

export class CreateMoneyCollectComponent implements OnInit {
  form!: FormGroup;
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<CreateMoneyCollectComponent>,
  ...
  okClick(): void {
    ...
    let data = {
      ledgerTypeId: 1,
      title: `Phiếu thu ngày ${date} bởi ${this.account?.username}`,
