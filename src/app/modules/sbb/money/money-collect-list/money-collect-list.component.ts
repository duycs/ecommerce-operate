...
import { MoneyCollectDataSource } from './money-collect-data-source';
...
import { MoneyCollectDetailComponent } from '../money-collect-detail/money-collect-detail.component';
import { CreateMoneyCollectComponent } from '../create-money-collect/create-money-collect.component';
import { AccountantService } from 'src/app/services/accountant.service';
import { DateService } from 'src/app/shared/date.service';
import { PrintService } from 'src/app/services/print.service';

@Component({
    selector: 'app-money-collect-list',
    templateUrl: './money-collect-list.component.html',
})

export class MoneyCollectListComponent implements OnInit {
    length = 50;
    pageSize = 10;
    pageIndex = 1;
    ...
    displayedColumns: string[] = ['numbericalOrder', 'code', 'moneyAccount', 'currency', 'customer', 'creator', 'reason', 'explain', 'money', 'createdDate', 'action'];

    dataSource!: MoneyCollectDataSource;
    ...
    constructor(
        ...
        this.dataSource = new MoneyCollectDataSource(this.accountantService);
    }
    ...
    getQueryParams() {
        ...
        queryParams.ledgerTypeId = 1; // phiếu thu
    ...
    addMoneyAccount() {
        const dialogRef = this.dialog.open(CreateMoneyCollectComponent, {
            data: {
            },
            width: '700px'
        });
    ...
    openDetail(element: any) {
        const dialogRef = this.dialog.open(MoneyCollectDetailComponent, {
            data: element,
        });
    ...
    print(element: any) {
        this.printService.printMoneyCollect(element.id);
      }
